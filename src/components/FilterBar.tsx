...
export function FilterBar({ filters, onChange, visibleCount, totalCount, onAdd }: Props) {
  const isFiltered =
    filters.query.trim() !== '' ||
  ...
  return (
    <div className="flex items-center gap-2 mb-4 sm:mb-0">
      ...
      <button
        ...
        className="px-3 sm:px-4 py-2 rounded-button bg-accent-btn text-white text-[13px] font-medium hover:bg-accent-btn-hover transition-colors focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 shrink-0"
      >
